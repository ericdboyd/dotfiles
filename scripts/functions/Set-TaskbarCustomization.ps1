...
Function Set-TaskbarCustomization {
    <#
        ...
        .PARAMETER RemoveTaskView
            Removes Task View from the Taskbar

        .PARAMETER RemoveWidgets
            Removes Widgets from the Taskbar

        .PARAMETER RemoveChat
            Removes Chat from the Taskbar

        .PARAMETER MoveStartLeft
            Moves the Start button to the left side of the Taskbar

        .PARAMETER RemoveSearch
            Removes the Search box from the Taskbar

        .PARAMETER StartMorePins
            Adds the Start button to the Taskbar

        .PARAMETER StartMoreRecommendations
            Adds the Start button to the Taskbar

        .PARAMETER RunForExistingUsers
            Runs the script for existing users

        .NOTES
            Name: Set-TaskbarCustomization
